		...
		'<div id="import-box">' +
			...
			'<div class="ta">' +
				'<div class="placeholder">' +
					...
					'You can only import JSON generated by this this tool on export. 3rd line of every export includes the impotable JSON. Your old dialog code written in Javascript will <strong>not</strong> work! <br><br>' +
					'Valid JSON is beautified (restructured) on paste <br> so that it is easier to read if necessary. <br></br>' +
		...
		myCodeMirror.on("change", function( a, b ) {
			...
			if ( paste ) {
				...
				try {
					...
					myCodeMirror.getDoc().setValue( beautifiedCode );
				} catch(e){
			...
			setTimeout(function() {
				...
				var importBoxH = importBox.height();
				var extraMargins = 80;
				if ( winH < importBoxH+60 ) {
