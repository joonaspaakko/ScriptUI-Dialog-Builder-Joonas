...
function numberInputs(){function r(e,t,i,a){var n=e.val();if(isNaN(n))e.val(v);else{n=parseInt(n,10);var d=$("#dialog .active"),r=d.width(),l=e.hasClass("width"),o=d.height(),s=e.hasClass("height");0===n&&e.hasClass("danger-zone")||l&&r<=n&&e.hasClass("danger-zone")||s&&o<=n&&e.hasClass("danger-zone")?e.removeClass("danger-zone"):(l&&n<r&&!e.hasClass("danger-zone")||s&&n<o&&!e.hasClass("danger-zone"))&&e.addClass("danger-zone");var c={min:parseInt(e.attr("min"),10),max:parseInt(e.attr("max"),10),step:a||parseInt(e.attr("step"),10),modifierStep:parseInt(e.attr("modifier-step"),10)},p=(i?c.modifierStep:c.step)||1,m=n<c.min,u=n>c.max,f=m||u;switch(t){case"blur":if(f){var g=m&&c.min||u&&c.max;e.val(g)}break;case"up":n<c.max&&(n=n+p>c.max?c.max:n+p,e.val(n),v=n);break;case"down":n>c.min&&(n=n-p<c.min?c.min:n-p,e.val(n),v=n);break}}item.funnel.update(e.data("edit"))}$(".number").wrap('<div class="number-wrap">');var v,e=$(".number-wrap");$('<div class="arrow plus"></div><div class="arrow minus"></div><div class="number-overlay"></div>').appendTo(e);var t=e.find(".number"),i=e.find(".number-overlay");t.each(function(){"none"===$(this).css("display")&&$(this).closest(".number-wrap").addClass("hide")});var l,o,s=!1,c=0,p=null,m=null;$(window).on("mousedown mousemove mouseup",function(e){if("mousedown"===e.type)s=!0,l=$(e.target).parent(),o=l.find("> .number");else if("mousemove"===e.type){if(s&&mousemovePing&&o.hasClass("number")){
...
},item.update.style.treeView=function(e,t,i){if("text"===e||"all"===e){var a=i.style.text;$('#panel-tree-view-wrap [data-item-id="'+i.id+'"] > .item-text').html(processItemName(a,i.type))}},item.update.style.dialogPreview=function(e,t,i,a){var n={property:e,value:i.style[e],data:t,dataItem:i,event:a};
...
e.html($(this).html().split("<br>").join("\n"));
...
var t=$(this).parent().hasClass("static-text"),i=$(this).parent().hasClass("edit-text");if(t||i){var a=$(this).height(),n=!1;t&&25.5<a?n=!0:i&&22.5<a&&(n=!0),n?$(this).addClass("multiline"):$(this).removeClass("multiline")}
