...
if(d.css({width:h,height:y+(0!=t[1]&&"Dialog"===i?23:"")}),"DropDownList"===i){var b=d.find(".drop-list-wrap"),w=d.find("label");d.removeClass("too-big"),d.removeClass("too-small"),d.addClass("get-width");var x=d.width(),C=w.outerWidth(!0),I=b.outerWidth(!0);d.removeClass("get-width");var S=C+I;S<h?(d.addClass("too-big"),I<x&&b.width("auto")):h<S&&(d.addClass("too-small"),x<I&&b.width(x-16),d.parent().parent().hasClass("orientation-row")&&
