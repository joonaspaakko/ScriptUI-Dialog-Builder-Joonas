...
// CHECKED
// PREFERRED SIZE
if(!0===s.checked&&(c+=p+l+".value = "+s.checked+"; \n"),void 0!==s.preferredSize&&"TreeView"!==a){var g=s.preferredSize[0],h=s.preferredSize[1];0<g&&(c+=p+l+".minimumSize.width = "+g+"; \n"),0<h&&(c+=p+l+".minimumSize.height = "+h+"; \n")}
// JUSTIFY
