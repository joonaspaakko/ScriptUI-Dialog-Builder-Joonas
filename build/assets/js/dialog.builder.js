...
// MARGINS
case"margins":var o=t[0],s=t[1],c=t[2],p=t[3],m="object"!=typeof t,f=m?t:o,u=m?t:s,v=m?t:c,g=m?t:p;"Dialog"===i?r.css({paddingTop:f<=6?1:f,paddingRight:u<=1?1:u,paddingBottom:v<=1?1:v,paddingLeft:g<=1?1:g}):"Panel"===i||"Tab"===i?r.css({paddingTop:f<=3?3:f,paddingRight:u<=3?3:u,paddingBottom:v<=1?1:v,paddingLeft:g<=3?3:g}):r.css({paddingTop:f,paddingRight:u,paddingBottom:v,paddingLeft:g});break;
// PREFERRED SIZE
case"preferredSize":
